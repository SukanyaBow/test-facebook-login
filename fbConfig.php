...
$redirectURL = 'https://tes-tlogin-facebook.herokuapp.com/'; // Callback URL i.e. page where you want to redirect after 														login, this should be same as oauth login in dashboard
